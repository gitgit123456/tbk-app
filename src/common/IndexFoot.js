...
class IndexFoot extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                   ...
                   <ul >
                       <li >
                           <Link to={'/'} className="home-link" >
                               <img src={this.state.pathname==="/index"?"http://shuzibika.com/tbk/home1.png":"http://shuzibika.com/tbk/home.png"}  alt=""/>
                               <span className={this.state.pathname==="/index"?"tab-active":""}>首页</span>
                           </Link>
                       </li>
                       <li >
                           <Link to={'/cate/1'} className="home-link " >
